...
export default function Peminjaman() {
  ...
  function focusDatePicker() {
    const el = document.getElementById("date-input-peminjaman");
    if (!el) return;
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <div className="relative">
              <input
                id="date-input-peminjaman" // ID Unik
                type={dateInputType}
                value={date}
                ...
                {currentItems.length === 0 ? (
                  ...
                  currentItems.map((row) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 font-medium">{row.nama || "-"}</td>
                      <td className="px-6 py-4 font-medium">{row.unit}</td>
                      <td className="px-6 py-4">
                        <button
                          className="text-blue-600 hover:text-blue-800 font-medium text-sm"
                          onClick={() => handleViewSurat(row)}
                        >
                          Lihat Detail
                        </button>
                      </td>
                      <td className="px-6 py-4">
                        <button
                          className="text-blue-600 hover:text-blue-800 font-medium text-sm"
                          onClick={() => handleViewTandaTerima(row)}
                        >
                          Lihat Detail
                        </button>
                      </td>
            ...
            <div className="p-4 border-t border-gray-200 bg-gray-50 flex justify-end items-center gap-4">
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="p-2 rounded-lg hover:bg-gray-200 disabled:opacity-50 text-gray-600"
                >
