  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        if (activeTab === "adding")
          setDataAdding((prev) => prev.filter((i) => i.id !== id));
        else if (activeTab === "borrowing")
          setDataBorrowing((prev) => prev.filter((i) => i.id !== id));
        ...
        <div className="flex-1 flex justify-center">
          <div className="relative w-full max-w-lg">
            <input
              ...
              className="w-full pl-5 pr-12 py-3 rounded-xl border border-gray-300 bg-white text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
            />
                ...
                {currentItems.length > 0 ? (
                  currentItems.map((row, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-sm text-center text-gray-800 font-semibold">
                        {row.spesifikasi}
                      </td>
